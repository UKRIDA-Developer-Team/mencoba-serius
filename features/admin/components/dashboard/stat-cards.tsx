...
const cards = [
    ...
    },
    {
        ...
        label: "Low Stock",
        sublabel: "Ingredients perlu diisi ulang",
        icon: AlertTriangle,
    ...
    },
    {
        ...
        label: "Pre-order",
        sublabel: "Produk tidak tersedia instan",
        icon: Clock,
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {cards.map(({ key, label, sublabel, icon: Icon, iconBg, iconColor, valueColor, urgent }) => {
                ...
                return (
                    <div
                        key={key}
                        className={`relative rounded-xl border p-5 bg-card transition-shadow hover:shadow-md ${urgent && value > 0
